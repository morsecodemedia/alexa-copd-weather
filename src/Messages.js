...
const WELCOME = "Welcome to COPD Weather!";
...
const ADDRESS_AVAILABLE = "Here is your country and postal code: ";
...
const HELP = "You can use this skill by asking something like: whats my copd weather forcast?";

const STOP = "There is nothing to stop. Did you mean to ask something else?";

const CANCEL = "End of line.";
